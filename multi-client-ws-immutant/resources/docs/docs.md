...
The `home-routes` handler in the `multi-client-ws-immutant.routes.home` namespace
...
The `home-page` function will in turn call the `multi-client-ws-immutant.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/multi_client_ws_immutant/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `multi-client-ws-immutant.handler` namespace:
...
Request middleware functions are located under the `multi-client-ws-immutant.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `multi-client-ws-immutant.dev-middleware` namespace found in
